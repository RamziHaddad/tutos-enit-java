...
alter sequence jobs_job_id_seq restart with 20;
...
alter sequence departments_department_id_seq restart with 12;
...
alter sequence dependents_dependent_id_seq restart with 31;
